...
# Banked per monitor: each one owns five ids and SUPER+1..5 picks within the
# bank of whichever monitor the pointer is over (hypr/lib/workspaces.lua).
WS_HOME=(
    "1 DP-1"      "2 DP-1"      "3 DP-1"      "4 DP-1"      "5 DP-1"
    "11 HDMI-A-1" "12 HDMI-A-1" "13 HDMI-A-1" "14 HDMI-A-1" "15 HDMI-A-1"
)
