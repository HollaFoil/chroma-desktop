...
Singleton {
    ...
    // Material 3 roles, matugen names in camelCase. Fallbacks are the palette
    // of the reference wallpaper so the shell draws before the first setwall.
    readonly property color primary:                get("primary", "#98ccf9")
    readonly property color onPrimary:              get("on_primary", "#003352")
    readonly property color primaryContainer:       get("primary_container", "#004a74")
    readonly property color onPrimaryContainer:     get("on_primary_container", "#cde5ff")
    ...
    readonly property color onPrimaryFixed:         get("on_primary_fixed", "#001d33")
    readonly property color onPrimaryFixedVariant:  get("on_primary_fixed_variant", "#004a74")
    readonly property color secondary:              get("secondary", "#b9c8da")
    readonly property color onSecondary:            get("on_secondary", "#233240")
    readonly property color secondaryContainer:     get("secondary_container", "#3a4857")
    readonly property color onSecondaryContainer:   get("on_secondary_container", "#d5e4f7")
    ...
    readonly property color onSecondaryFixed:       get("on_secondary_fixed", "#0e1d2a")
    readonly property color onSecondaryFixedVariant:get("on_secondary_fixed_variant", "#3a4857")
    readonly property color tertiary:               get("tertiary", "#d1bfe7")
    readonly property color onTertiary:             get("on_tertiary", "#372a4a")
    readonly property color tertiaryContainer:      get("tertiary_container", "#4e4062")
    readonly property color onTertiaryContainer:    get("on_tertiary_container", "#eddcff")
    ...
    readonly property color onTertiaryFixed:        get("on_tertiary_fixed", "#211534")
    readonly property color onTertiaryFixedVariant: get("on_tertiary_fixed_variant", "#4e4062")
    ...
    readonly property color onErrorContainer:       get("on_error_container", "#ffdad6")
    readonly property color background:             get("background", "#101418")
    readonly property color onBackground:           get("on_background", "#e0e3e8")
    readonly property color surface:                get("surface", "#101418")
    readonly property color onSurface:              get("on_surface", "#e0e3e8")
    readonly property color onSurfaceVariant:       get("on_surface_variant", "#c2c7cf")
    ...
    readonly property color inverseOnSurface:       get("inverse_on_surface", "#2d3135")
